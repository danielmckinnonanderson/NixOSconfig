...

{
  ...
  users.users.dan = {
    ...
    packages = with pkgs; [
      ...
      # Development / compilers / toolchains
      rustup # Rust (includes cargo, rustc, rust_analyzer)

      python3 # Python
      python311Packages.pip

      nodejs_20 # Node (TODO - Nix workflow akin to node version manager)
      ...
      clang-tools
      gcc13
      scons_3_1_2 # C++ build system

      sbcl # LISP compiler
      mitscheme # Scheme compiler
